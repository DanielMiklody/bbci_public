function [loss, lossSem, cfy_out]= crossvalidationCSSDPMBprefilt(cnt_sig,cnt_noise,mrk, ival,varargin)
...
epo=proc_segmentation(cnt_sig,mrk,ival);
...
for rr= 1:length(divTr),
    ...
    for ff= 1:nFolds,
        ...
        W=cell(1,nFreq);
        for ii=1:nFreq
            [~,W{ii}]=proc_cssdp(proc_selectChannels(cnt_sig,['*ch' ii]),...
                proc_selectChannels(cnt_noise,['*ch' ii]),...
                mrk_selectEvents(mrk,idxTr),'ival',ival, ...
