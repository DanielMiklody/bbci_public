function [dat2, varargout]= proc_cssdp_onlineNoiseupdate(dat, W,score, varargin)
...
props= {'ScoreFcn'    {@score_eigenvalues}              '!FUNC|CELL'
        'lambda'      0.01                              'DOUBLE'
        'Verbose'     1                                 'INT'
       };
...
for ii=1:nEpo
    X=epo_noise.x(:,:,ii);
    C_n= (1-opt.lambda)*eye(nChans)+opt.lambda*W'*(X'*X)*W;
