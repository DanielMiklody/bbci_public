function [dat, varargout]= proc_csssp_prefilt_experimental(dat,epo_noise, varargin)
...
misc_checkType(epo_noise, 'STRUCT(x y)'); 
misc_checkType(epo_noise.y, 'DOUBLE[2 -]', 'dat.y');    % two classes only
...
epo_noise=proc_selectChannels(epo_noise,'*noise*');
